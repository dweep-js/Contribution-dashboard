<script>
    ...
    import {
        Sprout, BookOpen, Shield, Compass, Sword, Swords,
        Target, Award, Trophy, Star, Crown, Download, Flame, Users,
        GitBranch, Sparkles, ArrowLeft, Search
    } from "lucide-svelte";

    const iconMap = { Sprout, BookOpen, Shield, Compass, Sword, Swords, Target, Award, Trophy, Star, Crown };
    ...
    async function handleSubmit() {
        ...
        loading = true;
        try {
            passData = await fetchGitHubStats(username);
        } catch (error) {
...
<div class="page">
    {#if !passData}
        <section class="hero">
            ...
            <p class="hero-sub">Enter a GitHub username to generate a season pass from their contributions.</p>
